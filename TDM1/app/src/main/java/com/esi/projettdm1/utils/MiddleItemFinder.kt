...
class MiddleItemFinder(private val context: Context, private val layoutManager: LinearLayoutManager, private val callback: MiddleItemCallback, private val controlState: Int) : RecyclerView.OnScrollListener() {
    ...
    override fun onScrollStateChanged(recyclerView: RecyclerView?, newState: Int) {
        ...
        if (controlState == ALL_STATES || newState == controlState) {
            ...
            for (index in 0 until itemsCount) {
                ...
                val centerOffset = Math.abs(leftOffset - screenCenter) + Math.abs(rightOffset - screenCenter)
