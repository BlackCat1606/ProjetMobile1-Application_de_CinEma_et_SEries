...
class LinePagerIndicatorDecoration(private val context: Context) : RecyclerView.ItemDecoration() {
    ...
    private val colorInactive = R.color.transparent_black_hex_5
    ...
    private fun drawInactiveIndicators(c: Canvas, indicatorStartX: Float, indicatorPosY: Float, itemCount: Int) {
        mPaint.color = context.resources.getColor(colorInactive)
    ...
    private fun drawHighlights(c: Canvas, indicatorStartX: Float, indicatorPosY: Float,
        ...
        mPaint.color = context.resources.getColor(colorActive)
